...
export const LISTING_DETAIL_PHOTOS_SWIPE_LEFT = 'listing-detail-photos-swipe-left'
export const LISTING_DETAIL_PHOTOS_SWIPE_RIGHT = 'listing-detail-photos-swipe-right'
export const LISTING_DETAIL_PHOTOS_SWIPE_EDGE = 'listing-detail-photos-swipe-edge'
...
export const LISTING_DETAIL_FAVORITE_RELATED_LISTING = 'listing-detail-favorite-related-listing'
...
// PWA
export const PWA_APP_INSTALLED = 'pwa-app-installed'
...
export const PROFILE_OPEN_FAVORITES_CLICK = 'profile-open-favorites-click'
export const PROFILE_FAVORITES_OPEN = 'profile-favorites-open'
export const PROFILE_FAVORITES_VIEW_LISTING = 'profile-favorites-view-listing'
export const PROFILE_FAVORITES_VIEW_MAP = 'profile-favorites-view-map'
export const PROFILE_FAVORITES_BACK = 'profile-favorites-back'
export const PROFILE_FAVORITES_SCHEDULE_VISIT = 'profile-favorites-schedule-visit'
export const PROFILE_FAVORITES_VIEW_LISTINGS = 'profile-favorites-view-listings'
export const PROFILE_FAVORITES_MAP_DRAG = 'profile-favorites-map-drag'
export const PROFILE_FAVORITES_MAP_ZOOM = 'profile-favorites-map-zoom'
export const PROFILE_FAVORITES_MAP_CLICK_MARKER = 'profile-favorites-map-click-marker'
